...
declare const FrameCardTitle_base: typeof ShadowlessElement & import("@blocksuite/global/utils").Constructor<import("@blocksuite/global/lit").DisposableClass>;
export declare class FrameCardTitle extends FrameCardTitle_base {
    static styles: import("lit").CSSResult;
    private readonly _clearTitleDisposables;
    private readonly _mountTitleEditor;
