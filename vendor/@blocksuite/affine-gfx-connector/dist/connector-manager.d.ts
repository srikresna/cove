...
import type { GfxController, GfxLocalElementModel, GfxModel } from '@blocksuite/std/gfx';
...
export declare function isConnectorWithLabel(model: GfxModel | GfxLocalElementModel): boolean;
...
export declare function getNearestConnectableAnchor(ele: Connectable, point: IVec): PointLocation | null;
