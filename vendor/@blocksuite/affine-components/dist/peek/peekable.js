...
import { isInsideEdgelessEditor, matchModels, } from '@blocksuite/affine-shared/utils';
import { GfxBlockElementModel, GfxControllerIdentifier, } from '@blocksuite/std/gfx';
...
export const Peekable = (options = {
    ...
    const derivedClass = class extends Class {
        ...
        _peekableInEdgeless(e) {
            ...
            const hitTarget = gfx.getElementByPoint(...gfx.viewport.toModelCoordFromClientCoord([e.clientX, e.clientY]));
            if (hitTarget && hitTarget !== model) {
                ...
                if (hitTarget instanceof GfxBlockElementModel &&
