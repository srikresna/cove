...
import { modelContext, ShadowlessElement, stdContext, storeContext, TextSelection, } from '@blocksuite/std';
...
let BlockCaptionEditor = (() => {
    ...
    return class BlockCaptionEditor extends _classSuper {
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(_classSuper[Symbol.metadata] ?? null) : void 0;
            _caption_decorators = [state()];
            _display_decorators = [state()];
            _doc_decorators = [consume({ context: storeContext })];
