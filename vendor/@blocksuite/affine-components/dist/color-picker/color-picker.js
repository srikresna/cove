...
import { bound01, defaultHsva, eq, hsvaToHex8, hsvaToRgba, linearGradientAt, parseHexToHsva, renderCanvas, rgbaToHex8, rgbaToHsva, rgbToHex, rgbToHsv, } from './utils.js';
const TABS = [
...
let EdgelessColorPicker = (() => {
    ...
    return class EdgelessColorPicker extends _classSuper {
        ...
        #pick() {
            ...
            this.pick?.({ type: 'pick', detail: { key, value: value } });
        }
        #pickEnd() {
            this.pick?.({ type: 'end' });
        }
