...
import { EmbedOptionProvider, VirtualKeyboardProvider, } from '@blocksuite/affine-shared/services';
        ...
        constructor() {
            ...
            this._onConfirm = () => {
                ...
                if (mode === 'page') {
                    ...
                    this.host.store.addBlock(flavour, {
                        url,
                    }, parentModel, index);
                }
...
export async function toggleEmbedCardCreateModal(host, titleText, descriptionText, createOptions, onConfirm) {
