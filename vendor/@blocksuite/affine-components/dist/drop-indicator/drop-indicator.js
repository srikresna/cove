...
let DropIndicator = (() => {
    ...
    return class DropIndicator extends _classSuper {
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(_classSuper[Symbol.metadata] ?? null) : void 0;
            _rect_decorators = [property({ attribute: false })];
            _zIndex_decorators = [state()];
  ...
  `; }
        ...
        #zIndex_accessor_storage = (__runInitializers(this, _rect_extraInitializers), __runInitializers(this, _zIndex_initializers, 2));
