...
declare const DatePicker_base: typeof LitElement & import("@blocksuite/global/utils").Constructor<import("@blocksuite/global/lit").DisposableClass>;
/**
 * Date picker
 */
export declare class DatePicker extends DatePicker_base {
    ...
    private _cursor;
    private readonly _maxYear;
    private readonly _minYear;
    get _cardStyle(): {
        '--cell-size': string;
        '--gap-h': string;
        '--gap-v': string;
    ...
    accessor onClear: (() => void) | undefined;
