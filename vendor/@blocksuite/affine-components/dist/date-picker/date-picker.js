...
let DatePicker = (() => {
    ...
    return class DatePicker extends _classSuper {
        static {
            ...
            __esDecorate(this, null, _popup_decorators, { kind: "accessor", name: "popup", static: false, private: false, access: { has: obj => "popup" in obj, get: obj => obj.popup, set: (obj, value) => { obj.popup = value; } }, metadata: _metadata }, _popup_initializers, _popup_extraInitializers);
    ...
    >
      ...
      ${days.map(day => html `<div class="date-cell">${day}</div>`)}
        ...
        _modeDecade(offset) {
            this._yearCursor = clamp(this._yearCursor + offset, this._minYear, this._maxYear);
            this._getYearMatrix();
        }
        _monthContent() {
            return html ` <div class="date-picker-header">
      ...
      <div class=${classes} style=${styleMap(this._cardStyle)}>
        ...
        #popup_accessor_storage;
        get popup() { return this.#popup_accessor_storage; }
        set popup(value) { this.#popup_accessor_storage = value; }
        ...
        constructor() {
            ...
            this.#onClear_accessor_storage = (__runInitializers(this, _onChange_extraInitializers), __runInitializers(this, _onClear_initializers, undefined));
            this.#onEscape_accessor_storage = (__runInitializers(this, _onClear_extraInitializers), __runInitializers(this, _onEscape_initializers, undefined));
            ...
            this.#popup_accessor_storage = (__runInitializers(this, _padding_extraInitializers), __runInitializers(this, _popup_initializers, false));
            this.#size_accessor_storage = (__runInitializers(this, _popup_extraInitializers), __runInitializers(this, _size_initializers, 28));
