 ...
 * ```
 */
export declare function createLitPortal({ computePosition: positionConfigOrFn, abortController, closeOnClickAway, positionStrategy, ...portalOptions }: AdvancedPortalOptions): {
