...
import { type Middleware, type Placement, type ReferenceElement } from '@floating-ui/dom';
...
declare const MenuComponent_base: typeof ShadowlessElement & import("@blocksuite/global/utils").Constructor<import("@blocksuite/global/lit").DisposableClass>;
...
declare const MobileMenuComponent_base: typeof ShadowlessElement & import("@blocksuite/global/utils").Constructor<import("@blocksuite/global/lit").DisposableClass>;
...
export declare const popFilterableSimpleMenu: (target: PopupTarget, options: MenuConfig[], onClose?: () => void, placement?: Placement) => void;
export {};
//# sourceMappingURL=menu-renderer.d.ts.map