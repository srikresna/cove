...
let EditorIconButton = (() => {
    ...
    let _iconContainerHeight_decorators;
    let _iconContainerHeight_initializers = [];
    let _iconContainerHeight_extraInitializers = [];
    ...
    return class EditorIconButton extends _classSuper {
        static {
            ...
            _iconContainerHeight_decorators = [property({ attribute: false })];
            ...
            __esDecorate(this, null, _iconContainerHeight_decorators, { kind: "accessor", name: "iconContainerHeight", static: false, private: false, access: { has: obj => "iconContainerHeight" in obj, get: obj => obj.iconContainerHeight, set: (obj, value) => { obj.iconContainerHeight = value; } }, metadata: _metadata }, _iconContainerHeight_initializers, _iconContainerHeight_extraInitializers);
  ...
  `; }
    ...
    `;
        ...
        #iconContainerHeight_accessor_storage = (__runInitializers(this, _iconContainerWidth_extraInitializers), __runInitializers(this, _iconContainerHeight_initializers, undefined));
        get iconContainerHeight() { return this.#iconContainerHeight_accessor_storage; }
        set iconContainerHeight(value) { this.#iconContainerHeight_accessor_storage = value; }
        #iconSize_accessor_storage = (__runInitializers(this, _iconContainerHeight_extraInitializers), __runInitializers(this, _iconSize_initializers, undefined));
