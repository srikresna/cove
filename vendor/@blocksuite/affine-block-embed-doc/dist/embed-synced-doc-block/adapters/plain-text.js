...
export const embedSyncedDocBlockPlainTextAdapterMatcher = {
    ...
    fromBlockSnapshot: {
        enter: async (o, context) => {
            ...
            if (walkerContext.getGlobalContext('embed-synced-doc-counter') ===
                undefined) {
                walkerContext.setGlobalContext('embed-synced-doc-counter', 0);
            }
            let counter = walkerContext.getGlobalContext('embed-synced-doc-counter');
        ...
        leave: (_, context) => {
            ...
            const counter = walkerContext.getGlobalContext('embed-synced-doc-counter');
            walkerContext.setGlobalContext('embed-synced-doc-counter', counter - 1);
        },
    },
};
export const EmbedSyncedDocBlockPlainTextAdapterExtension = BlockPlainTextAdapterExtension(embedSyncedDocBlockPlainTextAdapterMatcher);
