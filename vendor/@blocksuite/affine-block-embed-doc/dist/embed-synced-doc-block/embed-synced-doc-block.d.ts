...
import { type DocLinkClickedEvent } from '@blocksuite/affine-inline-reference';
import { type AliasInfo, type DocMode, type EmbedSyncedDocModel, type ReferenceInfo } from '@blocksuite/affine-model';
import { type EditorHost } from '@blocksuite/std';
import { type PropertyValues } from 'lit';
import { type StyleInfo } from 'lit/directives/style-map.js';
import type { EmbedSyncedDocCard } from './components/embed-synced-doc-card.js';
export declare class EmbedSyncedDocBlockComponent extends EmbedBlockComponent<EmbedSyncedDocModel> {
    static styles: import("lit").CSSResult;
    private _cachedBounds;
    private _hasRenderedSyncedView;
    private _hasInitedFitEffect;
    private readonly _initEdgelessFitEffect;
    private readonly _pageFilter;
    protected _buildPreviewSpec: (name: "preview-page" | "preview-edgeless") => import("@blocksuite/store").ExtensionType[];
    protected _renderSyncedView: () => import("lit-html").TemplateResult<1>;
    protected cardStyleMap: import("lit-html/directive.js").DirectiveResult<typeof import("lit-html/directives/style-map.js").StyleMapDirective>;
    ...
    open: (event?: Partial<DocLinkClickedEvent>) => void;
    refreshData: () => void;
    ...
    get linkedMode(): "page" | "edgeless" | undefined;
    get referenceInfo(): ReferenceInfo;
    get syncedDoc(): import("@blocksuite/store").Store | null;
    private _checkCycle;
