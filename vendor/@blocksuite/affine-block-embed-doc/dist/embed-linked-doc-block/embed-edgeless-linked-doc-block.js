import { createEmbedEdgelessBlockInteraction, toEdgelessEmbedBlock, } from '@blocksuite/affine-block-embed';
...
import { cloneReferenceInfoWithoutAliases, isNewTabTrigger, isNewViewTrigger, } from '@blocksuite/affine-shared/utils';
...
export class EmbedEdgelessLinkedDocBlockComponent extends toEdgelessEmbedBlock(EmbedLinkedDocBlockComponent) {
    constructor() {
        ...
        this.convertToEmbed = () => {
            ...
            const newId = addBlock('affine:embed-synced-doc', {
...
export const EmbedLinkedDocInteraction = createEmbedEdgelessBlockInteraction(EmbedLinkedDocBlockSchema.model.flavour);
