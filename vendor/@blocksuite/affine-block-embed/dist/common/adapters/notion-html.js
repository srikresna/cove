...
export function createEmbedBlockNotionHtmlAdapterMatcher(flavour, urlRegex, { toMatch = o => {
    const isFigure = HastUtils.isElement(o.node) && o.node.tagName === 'figure';
...
}, fromMatch = o => o.node.flavour === flavour, toBlockSnapshot = {
    enter: (o, context) => {
...
}, fromBlockSnapshot = {}, } = Object.create(null)) {
    return {
        flavour,
        toMatch,
        fromMatch,
