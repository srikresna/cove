...
export class EmbedEdgelessHtmlBlockComponent extends toEdgelessEmbedBlock(EmbedHtmlBlockComponent) {
}
export const EmbedEdgelessHtmlBlockInteraction = createEmbedEdgelessBlockInteraction(EmbedHtmlBlockSchema.model.flavour, {
    resizeConstraint: {
