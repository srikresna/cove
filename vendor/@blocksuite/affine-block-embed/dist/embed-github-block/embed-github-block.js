...
let EmbedGithubBlockComponent = (() => {
    ...
    return class EmbedGithubBlockComponent extends _classSuper {
        static {
        ...
        renderBlock() {
            const { title, githubType, status, statusReason, owner, repo, createdAt, assignees, description, image, style, } = this.model.props;
