...
const spotifyUrlValidationOptions = {
    protocols: ['https:'],
    hostnames: ['open.spotify.com', 'spotify.link'],
};
const spotifyIframeUrlValidationOptions = {
    protocols: ['https:'],
    hostnames: ['open.spotify.com'],
};
export const spotifyConfig = {
    name: 'spotify',
    match: (url) => validateEmbedIframeUrl(url, spotifyUrlValidationOptions),
    buildOEmbedUrl: (url) => {
