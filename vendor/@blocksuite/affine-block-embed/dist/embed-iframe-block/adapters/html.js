...
export const embedIframeBlockHtmlAdapterMatcher = createEmbedBlockHtmlAdapterMatcher(EmbedIframeBlockSchema.model.flavour, {
    fromBlockSnapshot: {
        enter: (o, context) => {
...
export const EmbedIframeBlockHtmlAdapterExtension = BlockHtmlAdapterExtension(embedIframeBlockHtmlAdapterMatcher);
