...
import { EMBED_IFRAME_DEFAULT_HEIGHT_IN_SURFACE, EMBED_IFRAME_DEFAULT_WIDTH_IN_SURFACE, } from '../consts';
export const insertEmbedIframeWithUrlCommand = (ctx, next) => {
    const { url, std } = ctx;
    ...
    if (selectedBlockId) {
        ...
        newBlockId = crud.addBlock(flavour, {
            ...props,
            xywh,
        }, surfaceBlock.model);
