...
import { CanvasElementType, DefaultTool, EdgelessCRUDIdentifier, getSurfaceBlock, TextUtils, } from '@blocksuite/affine-block-surface';
    ...
    >
      ...
      ${isEmpty
        ...
        constructor() {
            ...
            this._updateRect = () => {
                const element = this.element;
                if (!element || !this.inlineEditorContainer)
                    return;
            ...
            this.#element_accessor_storage = (__runInitializers(this, _std_extraInitializers), __runInitializers(this, _element_initializers, void 0));
