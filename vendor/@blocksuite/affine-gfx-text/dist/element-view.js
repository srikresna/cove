...
export class TextElementView extends GfxElementModelView {
...
export const TextInteraction = GfxViewInteractionExtension(TextElementView.type, {
    resizeConstraint: {
    ...
    handleResize({ model }) {
        ...
        return {
            ...
            onResizeMove(context) {
                ...
                if (handle === 'left' || handle === 'right') {
                    const { text: yText, fontFamily, fontSize, fontStyle, fontWeight, hasMaxWidth, } = model;
