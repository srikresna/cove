...
import { getFontString, getLineHeight, getTextWidth, isRTL, wrapTextDeltas, } from './utils.js';
export const text = (model, ctx, matrix, renderer) => {
    const { fontSize, fontWeight, fontStyle, fontFamily, textAlign, rotate } = model;
    ...
    const color = renderer.getColorValue(model.color, DefaultTheme.textColor, true);
    ctx.font = font;
    ctx.fillStyle = color;
...
export const TextElementRendererExtension = ElementRendererExtension('text', text);
export * from './utils';
