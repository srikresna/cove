...
import { ColorScheme, FrameBlockModel, isTransparent, } from '@blocksuite/affine-model';
import { ThemeProvider } from '@blocksuite/affine-shared/services';
import { on } from '@blocksuite/affine-shared/utils';
import { Bound } from '@blocksuite/global/gfx';
import { SignalWatcher, WithDisposable } from '@blocksuite/global/lit';
import { PropTypes, requiredProperties, stdContext, } from '@blocksuite/std';
...
let AffineFrameTitle = (() => {
    ...
    var AffineFrameTitle = class extends _classSuper {
        ...
        connectedCallback() {
            ...
            _disposables.add(doc.slots.blockUpdated.subscribe(payload => {
            ...
            _disposables.add(this.model.propsUpdated.subscribe(() => {
            ...
            _disposables.add(gfx.viewport.viewportUpdated.subscribe(({ zoom }) => {
                this._zoom = zoom;
                this.requestUpdate();
            }));
            _disposables.add(on(this, 'dblclick', () => {
