import { AFFINE_FRAME_TITLE_WIDGET, AffineFrameTitleWidget, } from './affine-frame-title-widget.js';
...
export function effects() {
    ...
    customElements.define('edgeless-frame-title-editor', EdgelessFrameTitleEditor);
}
