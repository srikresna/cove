...
import { type TextDelta } from '@blocksuite/affine-gfx-text';
import type { LocalShapeElementModel, ShapeElementModel, TextAlign, TextVerticalAlign } from '@blocksuite/affine-model';
