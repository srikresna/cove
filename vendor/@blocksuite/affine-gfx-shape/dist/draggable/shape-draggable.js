...
import { CanvasElementType, DefaultTool, EdgelessCRUDIdentifier, } from '@blocksuite/affine-block-surface';
import { getShapeRadius, getShapeType, ShapeType, } from '@blocksuite/affine-model';
import { EditPropsStore, TelemetryProvider, ThemeProvider, ViewportElementProvider, } from '@blocksuite/affine-shared/services';
            ...
            this.edgeless.bindHotKey({
                s: ctx => {
                    ...
                    if (this.readyToDrop) {
                        ...
                        if (this.gfx.tool.dragging$.peek())
                            return;
                        let shapeName = this.gfx.tool.get(ShapeTool).activatedOption.shapeName;
                        if (currentTool === ShapeTool.toolName) {
