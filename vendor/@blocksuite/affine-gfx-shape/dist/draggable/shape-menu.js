...
import { DefaultTheme, isTransparent, ShapeStyle, ShapeType, } from '@blocksuite/affine-model';
  ...
  `; }
    ...
    `;
        ...
        constructor() {
            ...
            this._setFillColor = ({ key, value }) => {
                const filled = !isTransparent(value);
                const fillColor = value;
                const strokeColor = filled
                    ? DefaultTheme.StrokeColorShortPalettes.find(palette => palette.key === key)?.value
