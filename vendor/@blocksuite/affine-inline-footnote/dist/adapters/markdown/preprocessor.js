 ...
 * ```
 */
export function preprocessFootnoteReference(content) {
...
const footnoteReferencePreprocessor = {
...
export const FootnoteReferenceMarkdownPreprocessorExtension = MarkdownPreprocessorExtension(footnoteReferencePreprocessor);
