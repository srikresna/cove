...
export type WithParams<Map, T> = {
    [K in keyof Map]: Map[K] & T;
};
...
export type DatabaseAllViewEvents = DatabaseViewEvents & WithParams<DatabaseAllSortEvents, SortParams> & DatabasePropertyEvents & DatabaseFilterEvents & DatabaseGroupEvents;
