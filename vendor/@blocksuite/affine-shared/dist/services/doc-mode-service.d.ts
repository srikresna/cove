...
export declare const DocModeProvider: import("@blocksuite/global/di").ServiceIdentifier<DocModeProvider> & (<U extends DocModeProvider = DocModeProvider>(variant: import("@blocksuite/global/di").ServiceVariant) => import("@blocksuite/global/di").ServiceIdentifier<U>);
export declare class DocModeService extends Extension implements DocModeProvider {
    ...
    onPrimaryModeChange(handler: (mode: DocMode) => void, id: string): Subscription;
    setEditorMode(mode: DocMode): void;
