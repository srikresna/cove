...
import { type AssetsManager, type ASTWalker, type ASTWalkerContext, type BaseAdapter, type BlockSnapshot, type NodeProps, type Transformer } from '@blocksuite/store';
import type { DeltaASTConverter } from './delta-converter.js';
export declare const isBlockSnapshotNode: (node: unknown) => node is BlockSnapshot;
export type TextBuffer = {
    content: string;
};
export type AdapterContext<ONode extends object, TNode extends object = never, TConverter extends DeltaASTConverter = DeltaASTConverter> = {
 ...
 */
export type BlockAdapterMatcher<TNode extends object = never, TConverter extends DeltaASTConverter = DeltaASTConverter> = {
    ...
    toBlockSnapshot: {
         ...
         */
        enter?: (o: NodeProps<TNode>, context: AdapterContext<TNode, BlockSnapshot, TConverter>) => void | Promise<void>;
        /**
         * Called when leaving a target walker node during traversal
         * @param o - The target node properties
         * @param context - The adapter context
         */
        leave?: (o: NodeProps<TNode>, context: AdapterContext<TNode, BlockSnapshot, TConverter>) => void | Promise<void>;
    };
    /**
    ...
    fromBlockSnapshot: {
         ...
         * @param context - The adapter context
         */
        enter?: (o: NodeProps<BlockSnapshot>, context: AdapterContext<BlockSnapshot, TNode, TConverter>) => void | Promise<void>;
        /**
         * Called when leaving a BlockSnapshot walker node during traversal
         * @param o - The BlockSnapshot properties
         * @param context - The adapter context
         */
        leave?: (o: NodeProps<BlockSnapshot>, context: AdapterContext<BlockSnapshot, TNode, TConverter>) => void | Promise<void>;
    };
};
export type AdapterFactory = {
    get: (job: Transformer) => BaseAdapter;
};
export declare const AdapterFactoryIdentifier: import("@blocksuite/global/di").ServiceIdentifier<AdapterFactory> & (<U extends AdapterFactory = AdapterFactory>(variant: import("@blocksuite/global/di").ServiceVariant) => import("@blocksuite/global/di").ServiceIdentifier<U>);
