function safeDecodePathReference(path) {
    try {
...
export function normalizeFilePathReference(path) {
 ...
 */
function resolveFullPath(basePath, relativePath) {
 ...
 */
export function getImageFullPath(filePath, imageReference) {
