import { type AssetsManager, BaseAdapter, type BlockSnapshot, type DocSnapshot, type ExtensionType, type FromBlockSnapshotResult, type FromDocSnapshotResult, type FromSliceSnapshotResult, type SliceSnapshot } from '@blocksuite/store';
...
export declare const NotionTextAdapterFactoryIdentifier: import("@blocksuite/global/di").ServiceIdentifier<import("./types").AdapterFactory>;
