import { type AffineCssVariables, type AffineTheme } from '@toeverything/theme';
...
export declare const unsafeCSSVar: (key: keyof AffineCssVariables | keyof AffineTheme, fallback?: string) => import("lit").CSSResult;
export declare const unsafeCSSVarV2: (key: AffineThemeKeyV2, fallback?: string) => import("lit").CSSResult;
