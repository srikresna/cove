import { CodeBlockSchemaExtension, DatabaseBlockSchemaExtension, ImageBlockSchemaExtension, ListBlockSchemaExtension, NoteBlockSchemaExtension, ParagraphBlockSchemaExtension, RootBlockSchemaExtension, } from '@blocksuite/affine-model';
...
export function createAffineTemplate(extensions = DEFAULT_EXTENSIONS) {
    /**
     ...
     * ```
     */
    function affine(strings, ...values) {
 ...
 * @returns
 */
function buildDocFromElement(doc, element, parentId, selectionInfo) {
    ...
    Array.from(element.children).forEach(child => {
        if (child.nodeType === Node.ELEMENT_NODE) {
            ...
            buildDocFromElement(doc, child, blockId, selectionInfo);
        }
