...
describe('test handleNativeRangeAtPoint', () => {
    let caretRangeFromPointSpy;
    let resetNativeSelectionSpy;
    beforeEach(() => {
        caretRangeFromPointSpy = vi.spyOn(PointToRangeUtils.api, 'caretRangeFromPoint');
        resetNativeSelectionSpy = vi.spyOn(PointToRangeUtils.api, 'resetNativeSelection');
    });
