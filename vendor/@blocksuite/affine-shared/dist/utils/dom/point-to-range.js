...
export function caretRangeFromPoint(clientX, clientY) {
    if (IS_FIREFOX) {
        ...
        if (caret.offsetNode.nodeType === Node.TEXT_NODE) {
            ...
            const elementNode = caret.offsetNode;
...
function lastMeaningfulTextNode(node) {
