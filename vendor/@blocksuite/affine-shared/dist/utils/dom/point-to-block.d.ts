import { type Point, type Rect } from '@blocksuite/global/gfx';
 ...
 */
export declare function getBlockComponentsExcludeSubtrees(elements: BlockComponent[]): BlockComponent[];
