...
function getVisiblePreviousElementSibling(element) {
    if (!element)
        return null;
...
function getVisibleNextElementSibling(element) {
    if (!element)
        return null;
 ...
 */
export function calcDropTarget(point, model, element, draggingElements = [], scale = 1, 
/**
