...
let AffineEdgelessZoomToolbarWidget = (() => {
  ...
  `; }
        ...
        firstUpdated() {
            ...
            disposables.add(slots.navigatorSettingUpdated.subscribe(({ hideToolbar }) => {
...
export const edgelessZoomToolbarWidget = WidgetViewExtension('affine:page', AFFINE_EDGELESS_ZOOM_TOOLBAR_WIDGET, literal `${unsafeStatic(AFFINE_EDGELESS_ZOOM_TOOLBAR_WIDGET)}`);
