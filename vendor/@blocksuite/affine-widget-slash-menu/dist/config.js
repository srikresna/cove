...
import { ArrowDownBigIcon, ArrowUpBigIcon, CopyIcon, DeleteIcon, DualLinkIcon, NowIcon, TodayIcon, TomorrowIcon, YesterdayIcon, } from '@blocksuite/icons/lit';
        ...
        return [
            ...
            },
            {
                ...
                action: ({ std, model }) => {
                    ...
                    host.store.addBlock(model.flavour, {
                        type: model.props.type,
                        text: new Text(model.props.text.toDelta()),
                        checked: model.props.checked,
                    }, host.store.getParent(model), index);
                },
            },
            {
                name: 'Delete',
