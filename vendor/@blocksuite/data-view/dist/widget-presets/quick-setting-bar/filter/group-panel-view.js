...
import { menu, popFilterableSimpleMenu, popMenu, popupTargetFromElement, } from '@blocksuite/affine-components/context-menu';
...
let FilterGroupView = (() => {
    ...
    return class FilterGroupView extends _classSuper {
        static {
              ...
              ${filter.type === 'filter'
                  ...
                  `
                    ...
                    <filter-group-view
                      ...
                      style="width: 100%;"
                      .depth="${this.depth + 1}"
                      .onChange="${(v) => this._setFilter(i, v)}"
                      .vars="${this.vars}"
    ...
    `;
        ...
        constructor() {
            ...
            this._addNew = (e) => {
                ...
                popAddNewFilter(popupTargetFromElement(e.currentTarget), {
            ...
            this._selectOp = (event) => {
                popFilterableSimpleMenu(popupTargetFromElement(event.currentTarget), [
                    menu.action({
                        name: 'And',
                        select: () => {
                            this.onChange({
            ...
            this.#depth_accessor_storage = (__runInitializers(this, _containerClass_extraInitializers), __runInitializers(this, _depth_initializers, 1));
            this.#onChange_accessor_storage = (__runInitializers(this, _depth_extraInitializers), __runInitializers(this, _onChange_initializers, void 0));
...
export const popFilterGroup = (target, props) => {
    popMenu(target, {
        options: {
            title: {
                text: 'Filter group',
