...
export declare const popAddNewFilter: (target: PopupTarget, props: {
    value: FilterGroup;
    onChange: (value: FilterGroup) => void;
    vars: Variable[];
}) => void;
declare const FilterGroupView_base: typeof ShadowlessElement;
export declare class FilterGroupView extends FilterGroupView_base {
    static styles: import("lit").CSSResult;
    private readonly _addNew;
    private readonly _selectOp;
...
export declare const popFilterGroup: (target: PopupTarget, props: {
...
export {};
//# sourceMappingURL=group-panel-view.d.ts.map