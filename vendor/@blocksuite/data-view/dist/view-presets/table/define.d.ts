...
export declare const tableViewType: {
    type: "table";
    createModel: <Data extends import("../../index.js").DataViewDataType>(model: import("../../index.js").DataViewModelConfig<Data>) => import("../../index.js").DataViewModel<"table", Data> & {
        createMeta: (renderer: import("../../index.js").DataViewRendererConfig) => import("../../index.js").ViewMeta<"table", Data>;
    };
};
...
export declare const tableViewModel: import("../../index.js").DataViewModel<"table", TableViewData> & {
