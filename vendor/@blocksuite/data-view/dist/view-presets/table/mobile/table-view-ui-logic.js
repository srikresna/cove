...
import { mobileTableViewContainer, mobileTableViewWrapper, } from './table-view-style.js';
export class MobileTableViewUILogic extends DataViewUILogicBase {
    constructor() {
      ...
      >
        ...
        this.renderer = createUniComponentFromWebComponent(MobileTableViewUI);
    }
    get readonly() {
        return this.view.readonly$.value;
    }
}
export class MobileTableViewUI extends DataViewUIBase {
    connectedCallback() {
    ...
    renderTable() {
        ...
        <div style="display:flex;flex-direction: column;gap: 16px;">
          ${repeat(groupEntries, v => v.key, group => {
