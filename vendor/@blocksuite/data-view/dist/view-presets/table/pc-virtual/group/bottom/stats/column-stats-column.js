...
`;
let VirtualDatabaseColumnStatsCell = (() => {
    ...
    return class VirtualDatabaseColumnStatsCell extends _classSuper {
        static {
    ...
    >
      <div class="content">
        ...
        constructor() {
            ...
            this.cellValues$ = (__runInitializers(this, _column_extraInitializers), computed(() => {
                if (this.group) {
            ...
            this.openMenu = (ev) => {
                ...
                popMenu(popupTargetFromElement(ev.currentTarget), {
                    options: {
                        items: [
                            menu.action({
            ...
            this.statsResult$ = computed(() => {
                ...
                return {
                    ...
                    value: func.impl?.(this.values$.value, {
                        meta,
...
export { VirtualDatabaseColumnStatsCell };
