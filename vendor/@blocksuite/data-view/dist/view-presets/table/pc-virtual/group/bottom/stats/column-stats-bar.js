...
`;
let VirtualDataBaseColumnStats = (() => {
    ...
    return class VirtualDataBaseColumnStats extends _classSuper {
        static {
    ...
    `;
        ...
        #view_accessor_storage = (__runInitializers(this, _group_extraInitializers), __runInitializers(this, _view_initializers, void 0));
...
export { VirtualDataBaseColumnStats };
