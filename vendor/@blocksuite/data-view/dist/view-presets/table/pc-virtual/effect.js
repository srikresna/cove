...
export function pcVirtualEffects() {
    ...
    customElements.define('affine-database-virtual-cell-container', DatabaseCellContainer);
    customElements.define('virtual-table-header', VirtualTableHeader);
    customElements.define('virtual-data-view-column-preview', DataViewColumnPreview);
    customElements.define('virtual-database-header-column', DatabaseHeaderColumn);
    customElements.define('virtual-database-number-format-bar', DatabaseNumberFormatBar);
    ...
    customElements.define('data-view-virtual-table-vertical-indicator', TableVerticalIndicator);
    customElements.define('virtual-element-wrapper', VirtualElementWrapper);
    customElements.define('affine-database-virtual-column-stats', VirtualDataBaseColumnStats);
    customElements.define('affine-database-virtual-column-stats-cell', VirtualDatabaseColumnStatsCell);
