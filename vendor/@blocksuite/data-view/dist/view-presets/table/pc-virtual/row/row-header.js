...
let TableRowHeader = (() => {
    ...
    return class TableRowHeader extends _classSuper {
        static {
    ...
    `;
        ...
        constructor() {
            ...
            this.renderDragHandle = () => {
                const dragHandlerClass = clsx(styles.dragHandler, this.rowSelected$.value && styles.rowSelectedBg, this.rowHover$.value && styles.show);
                return html `
    ...
    `;
            ...
            this.showCheckbox$ = computed(() => {
                return this.rowSelected$.value || this.rowHover$.value;
            });
            this.renderCheckbox = () => {
                const classString = clsx(this.rowSelected$.value && styles.rowSelectedBg, styles.rowSelectCheckbox, this.showCheckbox$.value && styles.show);
                return html `
