...
let MobileKanbanCard = (() => {
    ...
    return class MobileKanbanCard extends _classSuper {
        static {
    ...
    `;
        ...
        constructor() {
            ...
            this.clickMore = (e) => {
                e.stopPropagation();
                popCardMenu(popupTargetFromElement(e.currentTarget), this.groupKey, this.cardId, this.kanbanViewLogic);
            };
            ...
            this.#kanbanViewLogic_accessor_storage = (__runInitializers(this, _isFocus_extraInitializers), __runInitializers(this, _kanbanViewLogic_initializers, void 0));
            __runInitializers(this, _kanbanViewLogic_extraInitializers);
        }
    };
})();
export { MobileKanbanCard };
