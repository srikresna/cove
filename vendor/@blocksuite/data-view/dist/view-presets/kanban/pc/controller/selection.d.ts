...
import type { KanbanCardSelection, KanbanCardSelectionCard, KanbanCellSelection, KanbanViewSelection, KanbanViewSelectionWithType } from '../../selection';
...
export declare class KanbanSelectionController implements ReactiveController {
    ...
    get view(): import("../..").KanbanSingleView;
