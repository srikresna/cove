...
export type CalendarViewData = BasicViewDataType<'calendar', CalendarViewDataShape>;
...
export type CalendarExternalSource = {
    ...
    getEntries(range: CalendarEntryRange): CalendarExternalEntry[] | Promise<CalendarExternalEntry[]>;
};
