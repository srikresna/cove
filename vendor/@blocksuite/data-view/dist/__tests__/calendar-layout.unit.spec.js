...
import { createCalendarMonthLayout, getCalendarDayContentSlots, getCalendarVisibleMonthRange, } from '../view-presets/calendar/index.js';
...
describe('calendar month layout', () => {
    it('buckets single day entries', () => {
        ...
        expect(layout.days.find(item => item.date === day('2026-05-15'))?.entries).toEqual([entry]);
    });
    ...
    it('keeps day buckets on local midnight across DST boundaries', () => {
        ...
        expect(layout.days.find(item => item.date === day('2026-03-09'))?.entries).toEqual([entry]);
    });
    ...
    it('keeps all same-day entries in the day bucket', () => {
        ...
        expect(layout.days.find(item => item.date === day('2026-05-15'))?.entries).toHaveLength(4);
    });
