import zod from 'zod';
export declare const NumberFormatSchema: zod.ZodEnum<["number", "numberWithCommas", "percent", "currencyYen", "currencyINR", "currencyCNY", "currencyUSD", "currencyEUR", "currencyGBP"]>;
