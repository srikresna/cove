...
let BaseGroup = (() => {
    ...
    return class BaseGroup extends _classSuper {
        ...
        #readonly_accessor_storage = (__runInitializers(this, _group_extraInitializers), __runInitializers(this, _readonly_initializers, void 0));
        ...
        updateValue(value) {
            this.group.manager.updateValue(this.group.rows.map(row => row.rowId), value);
        }
        get value() {
