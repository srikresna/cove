...
export const UserInfoSchema = Zod.object({
    userService: Zod.custom(() => true),
    userListService: Zod.custom(() => true),
});
...
const createTypeConvert = (from, to, convert) => {
    return {
        from,
        to,
        convert,
...
export const converts = [
    ...
    createTypeConvert(t.array.instance(unknown.instance()), unknown.instance(), value => value),
