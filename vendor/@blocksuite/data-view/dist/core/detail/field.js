...
let RecordField = (() => {
    ...
    return class RecordField extends _classSuper {
        static {
            ...
            this._clickLeft = (e) => {
                ...
                >
                  ${MoveLeftIcon()}
                                        ...
                                        hide: () => properties.findIndex(property => property.id === this.column.id) === 0,
                                        select: () => {
                ...
                >
                  ${MoveRightIcon()}
                                        ...
                                        hide: () => properties.findIndex(property => property.id === this.column.id) ===
                                            properties.length - 1,
                                        select: () => {
