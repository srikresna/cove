...
declare const Button_base: typeof ShadowlessElement & import("@blocksuite/global/utils").Constructor<import("@blocksuite/global/lit").DisposableClass>;
export declare class Button extends Button_base {
    static styles: import("lit").CSSResult;
    connectedCallback(): void;
    render(): TemplateResult<1>;
    accessor hoverType: 'background' | 'border';
