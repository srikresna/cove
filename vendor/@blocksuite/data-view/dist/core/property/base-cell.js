...
let BaseCellRenderer = (() => {
    ...
    let _isEditing$_decorators;
    let _isEditing$_initializers = [];
    let _isEditing$_extraInitializers = [];
    ...
    return class BaseCellRenderer extends _classSuper {
        static {
            ...
            _isEditing$_decorators = [property({ attribute: false })];
            ...
            __esDecorate(this, null, _isEditing$_decorators, { kind: "accessor", name: "isEditing$", static: false, private: false, access: { has: obj => "isEditing$" in obj, get: obj => obj.isEditing$, set: (obj, value) => { obj.isEditing$ = value; } }, metadata: _metadata }, _isEditing$_initializers, _isEditing$_extraInitializers);
        ...
        valueSetImmediate(value) {
            this.cell.valueSet(value);
        }
        valueSetNextTick(value) {
        ...
        onPaste(_e) { }
        #isEditing$_accessor_storage;
        get isEditing$() { return this.#isEditing$_accessor_storage; }
        set isEditing$(value) { this.#isEditing$_accessor_storage = value; }
        ...
        constructor() {
            ...
            this.readonly$ = (__runInitializers(this, _cell_extraInitializers), computed(() => {
                return this.cell.property.readonly$.value;
            }));
            this.value$ = computed(() => {
                return this.cell.value$.value;
            });
            this.#isEditing$_accessor_storage = __runInitializers(this, _isEditing$_initializers, void 0);
            this.#selectCurrentCell_accessor_storage = (__runInitializers(this, _isEditing$_extraInitializers), __runInitializers(this, _selectCurrentCell_initializers, void 0));
