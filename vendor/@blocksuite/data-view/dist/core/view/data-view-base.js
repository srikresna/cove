...
let DataViewUIBase = (() => {
    ...
    return class DataViewUIBase extends _classSuper {
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(_classSuper[Symbol.metadata] ?? null) : void 0;
...
export { DataViewUIBase };
export class DataViewUILogicBase {
    ...
    bindHotkey(hotkeys) {
        return this.root.config.bindHotkey(Object.fromEntries(Object.entries(hotkeys).map(([key, fn]) => [
            key,
            ctx => {
                return fn(ctx);
            },
