...
export interface DataViewModelConfig<Data extends DataViewDataType = DataViewDataType> {
    defaultName: string;
...
export type DataViewModel<Type extends string = DataViewMode, Data extends DataViewDataType = DataViewDataType> = {
    type: Type;
    model: DataViewModelConfig<Data>;
};
export type GetDataFromDataViewModel<Model> = Model extends DataViewModel<infer _, infer R> ? R : never;
...
export type ViewMeta<Type extends string = DataViewMode, Data extends DataViewDataType = DataViewDataType> = DataViewModel<Type, Data> & {
    renderer: DataViewRendererConfig;
};
export declare const viewType: <Type extends string>(type: Type) => {
    type: Type;
    createModel: <Data extends DataViewDataType>(model: DataViewModelConfig<Data>) => DataViewModel<Type, Data> & {
