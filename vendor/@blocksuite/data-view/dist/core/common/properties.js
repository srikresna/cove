...
let DataViewPropertiesSettingView = (() => {
    ...
    return class DataViewPropertiesSettingView extends _classSuper {
        static {
  ...
  `; }
    ...
    `;
        ...
        constructor() {
            ...
            this.items$ = (__runInitializers(this, _view_extraInitializers), computed(() => {
            ...
            this.sortContext = createSortContext({
                ...
                onDragEnd: evt => {
                    ...
                    if (over && over.id !== activeId) {
                        ...
                        this.view.propertyGetOrCreate(activeId).move(activeIndex > overIndex
                            ? {
                                before: true,
                                id: over.id,
                            }
...
export const popPropertiesSetting = (target, props, middleware) => {
