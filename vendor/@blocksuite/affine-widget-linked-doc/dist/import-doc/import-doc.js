...
import { CloseIcon, ExportToHTMLIcon, ExportToMarkdownIcon, NewIcon, } from '@blocksuite/affine-components/icons';
...
let ImportDoc = (() => {
    ...
    return class ImportDoc extends _classSuper {
        ...
        constructor(collection, schema, extensions, onSuccess, onFail, abortController = new AbortController()) {
            super();
        ...
        _onImportSuccess(pageIds, options = {}) {
            const { isWorkspaceFile = false, importedCount: pagesImportedCount = pageIds.length, docEmojis, } = options;
