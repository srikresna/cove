...
import { getImageFilesFromLocal, openSingleFileWith, } from '@blocksuite/affine-shared/utils';
...
let EdgelessNoteMenu = (() => {
  ...
  `; }
        ...
        _onHandleLinkButtonClick() {
            const [_, { insertedLinkType }] = this.edgeless.service.std.command.exec(insertLinkByQuickSearchCommand);
            insertedLinkType
                ?.then(type => {
