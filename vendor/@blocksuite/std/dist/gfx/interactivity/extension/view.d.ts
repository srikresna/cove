...
import type { BeforeResizeContext, BeforeRotateContext, ResizeConstraint, ResizeEndContext, ResizeMoveContext, ResizeStartContext, RotateEndContext, RotateMoveContext, RotateStartContext, SelectableContext, SelectContext } from '../types/view';
type ExtendedViewContext<T extends GfxBlockComponent | GfxElementModelView, Context, DefaultReturnType = void> = {
    /**
...
export type GfxViewInteractionConfig<T extends GfxBlockComponent | GfxElementModelView = GfxBlockComponent | GfxElementModelView> = {
    ...
    handleSelection?: (context: Omit<ViewInteractionHandleContext<T>, 'add' | 'delete'>) => {
        selectable?: (context: SelectableContext & ExtendedViewContext<T, SelectableContext, boolean>) => boolean;
        onSelect?: (context: SelectContext & ExtendedViewContext<T, SelectContext, boolean | void>) => boolean | void;
    };
};
export declare const GfxViewInteractionIdentifier: import("@blocksuite/global/di").ServiceIdentifier<GfxViewInteractionConfig<GfxBlockComponent<import("../..").GfxBlockElementModel<import("../..").GfxCompatibleProps>, import("../../..").BlockService, string> | GfxElementModelView<import("../..").GfxPrimitiveElementModel<import("../..").BaseElementProps> | import("../..").GfxLocalElementModel, object>>> & (<U extends GfxViewInteractionConfig<GfxBlockComponent<import("../..").GfxBlockElementModel<import("../..").GfxCompatibleProps>, import("../../..").BlockService, string> | GfxElementModelView<import("../..").GfxPrimitiveElementModel<import("../..").BaseElementProps> | import("../..").GfxLocalElementModel, object>> = GfxViewInteractionConfig<GfxBlockComponent<import("../..").GfxBlockElementModel<import("../..").GfxCompatibleProps>, import("../../..").BlockService, string> | GfxElementModelView<import("../..").GfxPrimitiveElementModel<import("../..").BaseElementProps> | import("../..").GfxLocalElementModel, object>>>(variant: import("@blocksuite/global/di").ServiceVariant) => import("@blocksuite/global/di").ServiceIdentifier<U>);
export declare function GfxViewInteractionExtension<T extends GfxBlockComponent | GfxElementModelView>(viewType: string, config: GfxViewInteractionConfig<T>): ExtensionType;
export {};
