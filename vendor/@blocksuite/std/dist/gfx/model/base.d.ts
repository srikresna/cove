import type { Bound, IBound, IVec, PointLocation, SerializedXYWH, XYWH } from '@blocksuite/global/gfx';
 ...
 */
export declare const gfxGroupCompatibleSymbol: unique symbol;
/**
 * Check if the element is a container element.
 */
export declare const isGfxGroupCompatibleModel: (elm: unknown) => elm is GfxGroupModel;
/**
