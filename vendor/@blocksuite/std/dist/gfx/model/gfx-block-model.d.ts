...
export declare class GfxBlockElementModel<Props extends GfxCompatibleProps = GfxCompatibleProps> extends BlockModel<Props> implements GfxCompatibleInterface {
    ...
    connectable: boolean;
    get xywh(): SerializedXYWH;
    get xywh$(): import("@preact/signals-core").Signal<Props["xywh"]>;
    set xywh(xywh: SerializedXYWH);
    get index(): string;
    get index$(): import("@preact/signals-core").Signal<Props["index"]>;
    set index(index: string);
    get lockedBySelf(): boolean | undefined;
    get lockedBySelf$(): import("@preact/signals-core").Signal<Props["lockedBySelf"]>;
