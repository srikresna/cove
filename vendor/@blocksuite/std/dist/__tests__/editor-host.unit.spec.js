...
import { HeadingBlockSchemaExtension, NoteBlockSchemaExtension, RootBlockSchemaExtension, SurfaceBlockSchemaExtension, } from './test-schema.js';
...
describe('editor host', () => {
    test('editor host should rerender model when view changes', async () => {
        ...
        headingBlock.model.props.type = 'h2';
        await wait(50);
