...
import { RootBlockSchemaExtension, SurfaceBlockSchemaExtension, } from '../test-schema.js';
effects();
...
describe('surface group index cache', () => {
    ...
    test('getGroup should recover from stale cache and update reverse lookup', () => {
        ...
        const fakeGroup = {
            id: 'group-fallback',
            hasChild: (element) => element.id === shapeId,
        };
        ...
        expect(surfaceModel.getGroup(shape)).toBe(fakeGroup);
    });
});
