  ...
  return class WidgetComponent extends _classSuper {
    static {
      ...
      __esDecorate(
        ...
        __store_initializers,
        __store_extraInitializers,
      );
      __esDecorate(
        this,
        null,
    ...
    get _store() {
      return this.#_store_accessor_storage;
    }
    set _store(value) {
      this.#_store_accessor_storage = value;
    }
    ...
    get _std() {
      return this.#_std_accessor_storage;
    }
    set _std(value) {
      this.#_std_accessor_storage = value;
    }
    constructor() {
      super(...arguments);
      ...
      this.#_model_accessor_storage =
        (__runInitializers(this, __store_extraInitializers),
        __runInitializers(this, __model_initializers, void 0));
      this.#_service_accessor_storage =
        (__runInitializers(this, __model_extraInitializers),
        __runInitializers(this, __service_initializers, void 0));
      this.#_std_accessor_storage =
        (__runInitializers(this, __service_extraInitializers),
        __runInitializers(this, __std_initializers, void 0));
