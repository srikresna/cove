...
let BlockComponent = (() => {
  ...
  var BlockComponent = class extends _classSuper {
    ...
    static {
      _a = ((_std_decorators = [consume({ context: stdContext })]), blockComponentSymbol);
    }
    static {
      const _metadata =
      ...
      __esDecorate(
        ...
        __model_initializers,
        __model_extraInitializers,
      );
      __esDecorate(
        this,
        null,
        __renderers_decorators,
        {
          kind: "accessor",
          name: "_renderers",
          static: false,
          private: false,
          access: {
            has: (obj) => "_renderers" in obj,
            get: (obj) => obj._renderers,
            set: (obj, value) => {
              obj._renderers = value;
            },
          },
          metadata: _metadata,
        },
        __renderers_initializers,
        __renderers_extraInitializers,
      );
      __esDecorate(
        this,
        null,
        __service_decorators,
        {
          kind: "accessor",
          name: "_service",
          static: false,
          private: false,
          access: {
            has: (obj) => "_service" in obj,
            get: (obj) => obj._service,
            set: (obj, value) => {
              obj._service = value;
            },
          },
        ...
        __service_initializers,
        __service_extraInitializers,
      );
      __esDecorate(
        this,
        null,
        ...
        _store_initializers,
        _store_extraInitializers,
      );
      __esDecorate(
        this,
        null,
        _viewType_decorators,
        {
          kind: "accessor",
          name: "viewType",
          static: false,
          private: false,
          access: {
            has: (obj) => "viewType" in obj,
            get: (obj) => obj.viewType,
            set: (obj, value) => {
              obj.viewType = value;
            },
          },
        ...
        _viewType_initializers,
        _viewType_extraInitializers,
      );
      __esDecorate(
        this,
        null,
    ...
    get std() {
      return this.#std_accessor_storage;
    }
    set std(value) {
      this.#std_accessor_storage = value;
    }
    get blockId() {
    ...
    get _model() {
      return this.#_model_accessor_storage;
    }
    set _model(value) {
      this.#_model_accessor_storage = value;
    }
    #_renderers_accessor_storage;
    get _renderers() {
      return this.#_renderers_accessor_storage;
    }
    set _renderers(value) {
      this.#_renderers_accessor_storage = value;
    }
    #_service_accessor_storage;
    get _service() {
      return this.#_service_accessor_storage;
    }
    set _service(value) {
      this.#_service_accessor_storage = value;
    }
    #store_accessor_storage;
    get store() {
      return this.#store_accessor_storage;
    }
    set store(value) {
      this.#store_accessor_storage = value;
    }
    #viewType_accessor_storage;
    get viewType() {
      return this.#viewType_accessor_storage;
    }
    set viewType(value) {
      this.#viewType_accessor_storage = value;
    }
    ...
    constructor() {
      ...
      this.#_renderers_accessor_storage =
        (__runInitializers(this, __model_extraInitializers),
        __runInitializers(this, __renderers_initializers, [
          this.renderBlock,
          this._renderMismatchBlock,
          this._renderViewType,
        ]));
      this.#_service_accessor_storage =
        (__runInitializers(this, __renderers_extraInitializers),
        __runInitializers(this, __service_initializers, null));
      this.#store_accessor_storage =
        (__runInitializers(this, __service_extraInitializers),
        __runInitializers(this, _store_initializers, void 0));
      this.#viewType_accessor_storage =
        (__runInitializers(this, _store_extraInitializers),
        __runInitializers(this, _viewType_initializers, "display"));
      this.#widgets_accessor_storage =
        (__runInitializers(this, _viewType_extraInitializers),
        __runInitializers(this, _widgets_initializers, void 0));
