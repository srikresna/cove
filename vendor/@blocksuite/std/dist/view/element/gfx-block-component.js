...
function handleGfxConnection(instance) {
    ...
    instance.disposables.add(viewport.viewportUpdated.subscribe(() => {
        ...
        if (viewport.SKIP_REFRESH_DURING_GESTURE &&
    ...
    instance.disposables.add(instance.gfx.layer.slots.layerUpdated.subscribe(() => {
        updateZIndex(instance);
    }));
