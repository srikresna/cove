...
export declare function renderableInEdgeless(doc: Store, surface: SurfaceBlockModel, block: GfxBlockElementModel): boolean;
export declare function compareIndex(aIndex: string, bIndex: string): SortOrder;
/**
 * A comparator function for sorting elements in the surface.
 * SortOrder.AFTER means a should be rendered after b and so on.
 * @returns
 */
export declare function compare(a: GfxModel | GfxLocalElementModel, b: GfxModel | GfxLocalElementModel): SortOrder;
