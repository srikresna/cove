...
export declare function lockElementImpl(doc: Store, element: GfxCompatibleInterface): void;
export declare function unlockElementImpl(doc: Store, element: GfxCompatibleInterface): void;
