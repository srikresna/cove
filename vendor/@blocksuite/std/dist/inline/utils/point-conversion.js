...
import { calculateTextLength, getInlineRootTextCache, getTextNodesFromElement, invalidateInlineRootTextCache, } from './text.js';
...
export function textPointToDomPoint(text, offset, rootElement) {
    ...
    for (let attempt = 0; attempt < 2; attempt++) {
        const { textNodes, textNodeIndexMap, prefixLengths, lineIndexMap } = getInlineRootTextCache(rootElement);
