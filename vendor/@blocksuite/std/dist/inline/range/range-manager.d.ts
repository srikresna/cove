...
export declare class RangeManager extends LifeCycleWatcher {
    ...
    clear(): void;
    getClosestBlock(node: Node): BlockComponent<import("@blocksuite/store").BlockModel<object>, import("../../index.js").BlockService, string> | null;
    getClosestInlineEditor(node: Node): import("../inline-editor.js").InlineEditor<{
    ...
    mounted(): void;
    queryInlineEditorByPath(path: string): import("../inline-editor.js").InlineEditor<{
        bold?: true | null | undefined;
        link?: string | null | undefined;
        strike?: true | null | undefined;
        italic?: true | null | undefined;
