...
export declare class InlineEditor<TextAttributes extends BaseTextAttributes = BaseTextAttributes> {
    ...
    get hooks(): {
        beforeinput?: ((props: import("./index.js").BeforeinputHookCtx<TextAttributes>) => void) | undefined;
        compositionEnd?: ((props: import("./index.js").CompositionEndHookCtx<TextAttributes>) => void) | undefined;
    };
    ...
    get rootElement(): InlineRootElement<TextAttributes> | null;
    private readonly _inlineRangeProviderOverride;
    ...
    readonly slots: {
        ...
        inlineRangeSync: Subject<Range | null>;
        /**
