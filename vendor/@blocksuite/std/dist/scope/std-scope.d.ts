...
export declare const internalExtensions: (
  | typeof ServiceManager
  | typeof RangeManager
  | typeof ViewStore
  | typeof UIEventDispatcher
  | typeof CommandManager
  | typeof LayerManager
  | typeof GridManager
  | typeof GfxSelectionManager
  | typeof SurfaceMiddlewareExtension
  | typeof ViewManager
)[];
export declare class BlockStdScope {
  ...
  get get(): <T>(
    identifier: import("@blocksuite/global/di").GeneralServiceIdentifier<T>,
    options?: import("@blocksuite/global/di").ResolveOptions,
  ) => T;
  get getOptional(): <T>(
    identifier: import("@blocksuite/global/di").GeneralServiceIdentifier<T>,
    options?: import("@blocksuite/global/di").ResolveOptions,
