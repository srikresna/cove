 ...
 */
export type RenderingState = 'inactive' | 'pending' | 'zooming' | 'rendering' | 'ready';
...
export interface BlockLayoutPainter {
    paint(ctx: OffscreenCanvasRenderingContext2D, block: BlockLayout, layoutBaseX: number, layoutBaseY: number): void;
}
