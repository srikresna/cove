import { getAffinePlaceholderFillColor, getAffinePlaceholderStrokeColor, inferColorSchemeFromThemeMode, } from '@blocksuite/affine-shared/theme';
import { getEffectiveDpr } from '@blocksuite/std/gfx';
import { BlockLayoutHandlersIdentifier } from './layout/block-layout-provider';
export function syncCanvasSize(canvas, host, zoom = 1) {
...
export function paintPlaceholder(canvas, layout, viewport) {
    ...
    const colorScheme = inferColorSchemeFromThemeMode(document.documentElement.dataset.theme);
