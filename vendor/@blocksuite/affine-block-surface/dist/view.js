...
import { EdgelessCRUDExtension, EdgelessLegacySlotExtension, EditPropsMiddlewareBuilder, } from './extensions';
...
export class SurfaceViewExtension extends ViewExtensionProvider {
    ...
    setup(context) {
        ...
        if (this.isEdgeless(context.scope)) {
            ...
            context.register(BlockViewExtension('affine:surface', literal `affine-surface`));
            context.register(EditPropsMiddlewareBuilder);
        }
        else {
            context.register(BlockViewExtension('affine:surface', literal `affine-surface-void`));
        }
    }
}
