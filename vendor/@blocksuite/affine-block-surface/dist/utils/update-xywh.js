import { ConnectorElementModel, MindmapElementModel, NOTE_MIN_HEIGHT, NOTE_MIN_WIDTH, NoteBlockModel, } from '@blocksuite/affine-model';
import { Bound, clamp } from '@blocksuite/global/gfx';
import { isGfxGroupCompatibleModel, } from '@blocksuite/std/gfx';
function updatChildElementsXYWH(container, targetBound, updateElement, updateBlock) {
...
export function updateXYWH(ele, bound, updateElement, updateBlock) {
