...
let SurfaceBlockComponent = (() => {
    ...
    return class SurfaceBlockComponent extends _classSuper {
        static {
  ...
  `; }
        ...
        _initRenderer() {
            ...
            if (useDOMRenderer) {
                ...
                this._disposables.add(this._renderer.stackingCanvasUpdated.subscribe(payload => {
            ...
            this._disposables.add(gfx.selection.slots.updated.subscribe(() => {
