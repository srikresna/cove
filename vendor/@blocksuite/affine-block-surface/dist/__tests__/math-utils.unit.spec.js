import { almostEqual, isPointOnLineSegment, lineEllipseIntersects, lineIntersects, linePolygonIntersects, linePolylineIntersects, pointAlmostEqual, polygonGetPointTangent, rotatePoints, toDegree, toRadian, } from '@blocksuite/global/gfx';
...
describe('Line', () => {
    ...
    it('lineEllipseIntersects', () => {
        ...
        if (!rst)
            throw new Error('Failed to get line ellipse intersects');
    ...
    it('linePolygonIntersects', () => {
        ...
        if (!rst)
            throw new Error('Failed to get line polygon intersects');
