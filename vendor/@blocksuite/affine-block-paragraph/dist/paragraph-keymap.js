...
import { CalloutBlockModel, ParagraphBlockModel, ParagraphBlockSchema, } from '@blocksuite/affine-model';
import { focusTextModel, getInlineEditorByModel, } from '@blocksuite/affine-rich-text';
import { calculateCollapsedSiblings, matchModels, } from '@blocksuite/affine-shared/utils';
...
import { canDedentParagraphCommand, dedentParagraphCommand, } from './commands/dedent-paragraph.js';
import { canIndentParagraphCommand, indentParagraphCommand, } from './commands/indent-paragraph.js';
...
export const ParagraphKeymapExtension = KeymapExtension(std => {
    return {
        Backspace: ctx => {
        ...
        Enter: ctx => {
            ...
            if (model.props.type.startsWith('h') && model.props.collapsed) {
                ...
                const newId = store.addBlock(model.flavour, { type: model.props.type, text: rightText }, parent, index + collapsedSiblings.length + 1);
