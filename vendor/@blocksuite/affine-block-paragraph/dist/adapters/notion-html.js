...
export const paragraphBlockNotionHtmlAdapterMatcher = {
            ...
            switch (o.node.tagName) {
                    ...
                    walkerContext.openNode({
                        ...
                        props: {
                            ...
                            text: {
                                ...
                                delta: deltaConverter.astToDelta(HastUtils.getInlineOnlyElementAST(o.node), { pageMap, removeLastBr: true }),
                            },
                        },
                        children: [],
                    }, 'children');
                ...
                case 'figure':
                    ...
                    if (HastUtils.querySelector(o.node, NotionCalloutToken)) {
                        ...
                        const iconSpan = HastUtils.querySelector(firstElementChild, '.icon');
...
export const ParagraphBlockNotionHtmlAdapterExtension = BlockNotionHtmlAdapterExtension(paragraphBlockNotionHtmlAdapterMatcher);
