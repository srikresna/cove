...
import { BlockElementCommentManager, CitationProvider, DocModeProvider, } from '@blocksuite/affine-shared/services';
import { calculateCollapsedSiblings, getNearestHeadingBefore, getViewportElement, } from '@blocksuite/affine-shared/utils';
...
let ParagraphBlockComponent = (() => {
    ...
    return class ParagraphBlockComponent extends _classSuper {
        constructor() {
            super(...arguments);
