...
import { z } from 'zod';
import { ReferenceNodeConfigExtension, ReferenceNodeConfigProvider, } from './reference-node/reference-config';
export const ReferenceInlineSpecExtension = InlineSpecExtension('reference', provider => {
