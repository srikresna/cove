...
import { EdgelessCRUDIdentifier, EdgelessLegacySlotIdentifier, getSurfaceBlock, } from '@blocksuite/affine-block-surface';
import { RootBlockSchema, } from '@blocksuite/affine-model';
import { BlockSuiteError, ErrorCode } from '@blocksuite/global/exceptions';
import { BlockService } from '@blocksuite/std';
import { GfxBlockElementModel, GfxControllerIdentifier, isGfxGroupCompatibleModel, ZOOM_MAX, ZOOM_MIN, ZOOM_STEP, } from '@blocksuite/std/gfx';
import { effect } from '@preact/signals-core';
import clamp from 'lodash-es/clamp';
import { getCursorMode } from './utils/query.js';
export class EdgelessRootService extends BlockService {
