import { ConnectorElementModel, GroupElementModel, MindmapElementModel, } from '@blocksuite/affine-model';
import { getTopElements, GfxBlockElementModel, isGfxGroupCompatibleModel, } from '@blocksuite/std/gfx';
/**
...
export function prepareCloneData(elements, std) {
