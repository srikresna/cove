...
import { pasteMiddleware, replaceIdMiddleware, surfaceRefToEmbed, uploadMiddleware, } from '@blocksuite/affine-shared/adapters';
import { clearAndSelectFirstModelCommand, deleteSelectedModelsCommand, getBlockIndexCommand, getBlockSelectionsCommand, getImageSelectionsCommand, getSelectedModelsCommand, getTextSelectionCommand, retainFirstModelCommand, } from '@blocksuite/affine-shared/commands';
...
export class PageClipboard extends ReadOnlyClipboard {
    constructor() {
        ...
        this.onPagePaste = ctx => {
            ...
            this.std.command
                ...
                hasPasteTarget = true;
                this.std.clipboard
                    .paste(e, this.std.store, ctx.parentBlock.model.id, ctx.blockIndex !== undefined ? ctx.blockIndex + 1 : 1)
                    .catch(console.error);
                return next();
            })
                .run();
            ...
            const parentModel = firstParagraphId
                ...
                : null;
            const paragraphIndex = firstParagraphId && parentModel
    ...
    static { this.key = 'affine-page-clipboard'; }
    mounted() {
