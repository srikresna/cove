...
import { type GfxController, GfxExtension, type GfxModel } from '@blocksuite/std/gfx';
...
export declare const EdgelessFrameManagerIdentifier: import("@blocksuite/global/di").ServiceIdentifier<EdgelessFrameManager>;
