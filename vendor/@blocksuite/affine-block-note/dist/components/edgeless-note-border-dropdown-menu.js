...
let EdgelessNoteBorderDropdownMenu = (() => {
    ...
    return class EdgelessNoteBorderDropdownMenu extends _classSuper {
        static {
    ...
    `;
        ...
        constructor() {
            super(...arguments);
            __runInitializers(this, _lineSize_extraInitializers);
        }
    };
})();
export { EdgelessNoteBorderDropdownMenu };
