...
import { BlockViewExtension, FlavourExtension, WidgetViewExtension, } from '@blocksuite/std';
...
const codeToolbarWidget = WidgetViewExtension('affine:code', AFFINE_CODE_TOOLBAR_WIDGET, literal `${unsafeStatic(AFFINE_CODE_TOOLBAR_WIDGET)}`);
export class CodeBlockViewExtension extends ViewExtensionProvider {
    ...
    setup(context) {
        ...
        if (!this.isMobile(context.scope)) {
            ...
            context.register(CodeBlockConfigExtension({
