import { CancelWrapIcon, CaptionIcon, CollapseCodeIcon, CopyIcon, DeleteIcon, DuplicateIcon, ExpandCodeIcon, WrapIcon, } from '@blocksuite/affine-components/icons';
        ...
        items: [
            {
                ...
                generate: ({ blockComponent, setActive }) => {
                    ...
                    return {
                        action: noop,
                        render: () => html `<language-list-button
            ...
            },
            {
                ...
                generate: ({ blockComponent }) => {
                    return {
                        ...
                        render: item => html `<editor-icon-button
...
export const toggleGroup = {
    ...
    items: [
        ...
        {
            type: 'line-number',
            when: ({ std }) => std.getOptional(CodeBlockConfigExtension.identifier)?.showLineNumbers ??
                true,
            generate: ({ blockComponent }) => {
                return {
                    action: () => { },
              ...
              <editor-menu-action
                @click=${() => {
                            const currentLineNumber = blockComponent.model.props.lineNumber ?? true;
