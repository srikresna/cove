...
type PropertyMeta<T extends BlockModel = BlockModel, RawValue = unknown, JsonValue = unknown, ColumnData extends NonNullable<unknown> = NonNullable<unknown>> = {
    name: string;
    key: string;
...
export declare const createBlockMeta: <T extends BlockModel>(options: Omit<BlockMeta<T>, "properties">) => {
    ...
    selector: (block: Block) => boolean;
    properties: PropertyMeta<BlockModel<object>, unknown, unknown, {}>[];
};
export {};
