import { BlockRenderer, DatabaseSelection, NoteRenderer, } from '@blocksuite/affine-block-database';
...
import { createRecordDetail, createUniComponentFromWebComponent, dataViewCommonStyle, DataViewRootUILogic, defineUniComponent, renderUniLit, uniMap, } from '@blocksuite/data-view';
...
export class DataViewBlockComponent extends CaptionedBlockComponent {
    constructor() {
        super(...arguments);
      ...
      `;
        ...
        this.dataViewRootLogic = new DataViewRootUILogic({
