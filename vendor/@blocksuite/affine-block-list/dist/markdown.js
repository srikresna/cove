import { ListBlockSchema, ParagraphBlockModel, } from '@blocksuite/affine-model';
...
export const ListMarkdownExtension = InlineMarkdownExtension({
    name: 'list',
    // group 2: number
    // group 3: bullet
    // group 4: bullet
    ...
    action: ({ inlineEditor, pattern, inlineRange, prefixText }) => {
        ...
        if (type !== 'numbered') {
            ...
            const id = store.addBlock(ListBlockSchema.model.flavour, {
                type: type,
