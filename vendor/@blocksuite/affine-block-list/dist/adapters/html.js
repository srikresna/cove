...
import { AdapterTextUtils, BlockHtmlAdapterExtension, HastUtils, } from '@blocksuite/affine-shared/adapters';
import { nanoid } from '@blocksuite/store';
export const listBlockHtmlAdapterMatcher = {
    ...
    toBlockSnapshot: {
        enter: (o, context) => {
            ...
            const listNumber = typeof parentList.properties.start === 'number'
            ...
            o.node = HastUtils.flatNodes(o.node, tagName => tagName === 'div' || tagName === 'p');
