...
import { AdapterTextUtils, BlockMarkdownAdapterExtension, } from '@blocksuite/affine-shared/adapters';
import { nanoid } from '@blocksuite/store';
const LIST_MDAST_TYPE = new Set(['list', 'listItem']);
const isListMDASTType = (node) => LIST_MDAST_TYPE.has(node.type);
export const listBlockMarkdownAdapterMatcher = {
    ...
    toBlockSnapshot: {
        enter: (o, context) => {
            ...
            if (o.node.type === 'listItem') {
                const parentList = o.parent?.node;
                ...
                walkerContext.openNode({
                    ...
                    props: {
                        ...
                        text: {
                            ...
                            delta: o.node.children[0] && o.node.children[0].type === 'paragraph'
    ...
    fromBlockSnapshot: {
        enter: (o, context) => {
            ...
            if (walkerContext.getNodeContext('affine:list:parent') === o.parent &&
                ...
                AdapterTextUtils.isNullish(currentTNode.children[0].checked) ===
                    AdapterTextUtils.isNullish(o.node.props.type === 'todo'
        ...
        leave: (o, context) => {
            ...
            if (walkerContext.getPreviousNodeContext('affine:list:parent') ===
                o.parent &&
...
export const ListBlockMarkdownAdapterExtension = BlockMarkdownAdapterExtension(listBlockMarkdownAdapterMatcher);
