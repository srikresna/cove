...
import { getNearestHeadingBefore, matchModels, } from '@blocksuite/affine-shared/utils';
import { TextSelection } from '@blocksuite/std';
import { correctNumberedListsOrderToPrev } from './utils.js';
export const canIndentListCommand = (ctx, next) => {
...
export const indentListCommand = (ctx, next) => {
    ...
    if (nextSibling)
        correctNumberedListsOrderToPrev(store, nextSibling);
    // 123
    //   > # 456
    // 789
    //
