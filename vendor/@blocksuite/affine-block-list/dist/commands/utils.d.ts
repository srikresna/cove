 ...
 */
export declare function correctNumberedListsOrderToPrev(doc: Store, modelOrId: BlockModel | string, transact?: boolean): void;
export declare function correctListOrder(doc: Store, model: ListBlockModel): void;
