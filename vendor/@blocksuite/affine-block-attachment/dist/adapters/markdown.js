import { AttachmentBlockSchema, FootNoteReferenceParamsSchema, } from '@blocksuite/affine-model';
import { BlockMarkdownAdapterExtension, createAttachmentBlockSnapshot, FOOTNOTE_DEFINITION_PREFIX, getFootnoteDefinitionText, isFootnoteDefinitionNode, } from '@blocksuite/affine-shared/adapters';
import { nanoid } from '@blocksuite/store';
const isAttachmentFootnoteDefinitionNode = (node) => {
    ...
    try {
        ...
        return (footnoteDefinitionJson.type === 'attachment' &&
...
export const AttachmentBlockMarkdownAdapterExtension = BlockMarkdownAdapterExtension(attachmentBlockMarkdownAdapterMatcher);
