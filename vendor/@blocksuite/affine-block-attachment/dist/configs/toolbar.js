...
import { AttachmentBlockModel, defaultAttachmentProps, } from '@blocksuite/affine-model';
...
import { CaptionIcon, CopyIcon, DeleteIcon, DownloadIcon, DuplicateIcon, EditIcon, ReplaceIcon, ResetIcon, } from '@blocksuite/icons/lit';
    ...
    actions: [
        ...
        },
        {
            ...
            run(ctx) {
                ...
                if (provider.shouldBeConverted(model) &&
...
const replaceAction = {
    ...
    disabled(ctx) {
        ...
        if (!block)
            return true;
        const { downloading = false, uploading = false } = block.resourceController.state$.value;
