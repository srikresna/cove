...
import { AttachmentBlockSchema, AttachmentBlockStyles, } from '@blocksuite/affine-model';
...
export const AttachmentBlockInteraction = GfxViewInteractionExtension(AttachmentBlockSchema.model.flavour, {
    resizeConstraint: {
        lockRatio: true,
    },
    handleRotate: () => {
