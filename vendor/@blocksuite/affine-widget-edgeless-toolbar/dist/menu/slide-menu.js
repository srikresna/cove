...
import { edgelessToolbarSlotsContext, } from '../index';
let EdgelessSlideMenu = (() => {
    ...
    return class EdgelessSlideMenu extends _classSuper {
        static {
            ...
            __menuContainer_decorators = [query('.menu-container-scrollable')];
  ...
  `; }
        ...
        firstUpdated() {
            ...
            this._disposables.add(this.toolbarSlots.resize.subscribe(() => this._toggleSlideButton()));
        }
        render() {
