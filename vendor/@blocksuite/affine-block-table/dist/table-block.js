...
import { RANGE_QUERY_EXCLUDE_ATTR, RANGE_SYNC_EXCLUDE_ATTR, } from '@blocksuite/std/inline';
...
export class TableBlockComponent extends CaptionedBlockComponent {
    ...
    connectedCallback() {
        ...
        this.disposables.addFromEvent(doc, 'selectionchange', () => {
            ...
            this.toggleAttribute('data-external-range-selection', hasExternalNativeSelection);
        ...
        this.disposables.addFromEvent(doc, 'pointerdown', event => {
    ...
    setInternalEditablesEnabled(enabled) {
        this.querySelectorAll('.inline-editor').forEach(editor => {
            if (enabled) {
