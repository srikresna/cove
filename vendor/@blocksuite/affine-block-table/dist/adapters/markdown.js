...
const isTableNode = (node) => TABLE_NODE_TYPES.has(node.type);
export const tableBlockMarkdownAdapterMatcher = {
...
export const TableBlockMarkdownAdapterExtension = BlockMarkdownAdapterExtension(tableBlockMarkdownAdapterMatcher);
