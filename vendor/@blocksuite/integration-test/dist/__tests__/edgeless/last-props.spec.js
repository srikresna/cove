...
import { DEFAULT_NOTE_SHADOW, DefaultTheme, FontFamily, LayoutType, MindmapStyle, NoteShadow, ShapeType, } from '@blocksuite/affine/model';
...
describe('apply last props', () => {
    ...
    test('shapes', () => {
        ...
        const rectShape = service.crud.getElementById(rectId);
        ...
        expect(std.get(EditPropsStore).lastProps$.value[`shape:${ShapeType.Rect}`]
            .fillColor).toBe(DefaultTheme.FillColorShortMap.Orange);
        // diamond shape
        ...
        const diamondShape = service.crud.getElementById(diamondId);
        ...
        expect(std.get(EditPropsStore).lastProps$.value[`shape:${ShapeType.Diamond}`]
            .fillColor).toBe(DefaultTheme.FillColorShortMap.Blue);
        // rounded rect shape
        ...
        const roundedRectShape = service.crud.getElementById(roundedRectId);
        expect(roundedRectShape.fillColor).toBe(DefaultTheme.FillColorShortMap.Yellow);
        service.crud.updateElement(roundedRectId, {
            fillColor: DefaultTheme.FillColorShortMap.Green,
        });
        expect(std.get(EditPropsStore).lastProps$.value['shape:roundedRect'].fillColor).toBe(DefaultTheme.FillColorShortMap.Green);
        // apply last props
        ...
        const rectShape2 = service.crud.getElementById(rectId2);
        ...
        const diamondShape2 = service.crud.getElementById(diamondId2);
        ...
        const roundedRectShape2 = service.crud.getElementById(roundedRectId2);
        expect(roundedRectShape2.fillColor).toBe(DefaultTheme.FillColorShortMap.Green);
    });
    test('connector', () => {
        ...
        const connector = service.crud.getElementById(id);
        ...
        const connector2 = service.crud.getElementById(id2);
        ...
        const connector3 = service.crud.getElementById(id3);
    ...
    test('brush', () => {
        ...
        const brush = service.crud.getElementById(id);
        expect(brush.color).toEqual(DefaultTheme.black);
        expect(brush.lineWidth).toBe(4);
        service.crud.updateElement(id, { lineWidth: 10 });
        const secondBrush = service.crud.getElementById(service.crud.addElement('brush', {}));
    ...
    test('text', () => {
        ...
        const text = service.crud.getElementById(id);
        expect(text.fontSize).toBe(24);
        service.crud.updateElement(id, { fontSize: 36 });
        const secondText = service.crud.getElementById(service.crud.addElement('text', {}));
    ...
    test('mindmap', () => {
        ...
        const mindmap = service.crud.getElementById(id);
        ...
        const mindmap2 = service.crud.getElementById(id2);
    ...
    test('edgeless-text', () => {
        ...
        const text2 = service.crud.getElementById(id2);
    ...
    test('note', () => {
        ...
        const note = service.crud.getElementById(id);
        ...
        const note2 = service.crud.getElementById(id2);
        expect(note2.props.background).toEqual(DefaultTheme.NoteBackgroundColorMap.Purple);
    ...
    test('frame', () => {
        ...
        const frame2 = service.crud.getElementById(id2);
        expect(frame2.props.background).toBe(DefaultTheme.StrokeColorShortMap.Purple);
        service.crud.updateElement(id2, {
        ...
        const frame3 = service.crud.getElementById(id3);
        ...
        const frame4 = service.crud.getElementById(id4);
