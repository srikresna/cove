...
import { DEFAULT_NOTE_HEIGHT, GroupElementModel, NoteBlockModel, NoteBlockSchema, NoteDisplayMode, SurfaceRefBlockSchema, } from '@blocksuite/affine-model';
    ...
    actions: [
        {
            ...
            run(ctx) {
                ...
                ctx.store.addBlock(SurfaceRefBlockSchema.model.flavour, { reference: groupId, refFlavour: 'group' }, lastNoteId);
