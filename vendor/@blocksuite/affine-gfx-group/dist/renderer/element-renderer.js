...
export const group = (model, ctx, matrix, renderer) => {
    const { xywh } = model;
...
export const GroupElementRendererExtension = ElementRendererExtension('group', group);
function renderTitle(model, ctx, renderer, renderParams) {
