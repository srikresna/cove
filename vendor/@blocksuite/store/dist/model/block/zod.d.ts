...
export declare const BlockSchema: z.ZodObject<
  {
    ...
    model: z.ZodObject<
      {
        ...
        props: z.ZodOptional<
          z.ZodFunction<
            z.ZodTuple<
              [z.ZodType<InternalPrimitives, z.ZodTypeDef, InternalPrimitives>],
              z.ZodUnknown
            >,
            z.ZodRecord<z.ZodString, z.ZodAny>
          >
        >;
        toModel: z.ZodOptional<
          z.ZodFunction<
            z.ZodTuple<[], z.ZodUnknown>,
            z.ZodType<BlockModel<object>, z.ZodTypeDef, BlockModel<object>>
          >
        >;
      },
      "strip",
      z.ZodTypeAny,
      {
        ...
        props?:
          | ((args_0: InternalPrimitives, ...args: unknown[]) => Record<string, any>)
          | undefined;
    ...
    >;
    transformer: z.ZodOptional<
      z.ZodFunction<
        z.ZodTuple<
          [z.ZodType<Map<string, unknown>, z.ZodTypeDef, Map<string, unknown>>],
          z.ZodUnknown
        >,
        z.ZodType<BaseBlockTransformer<object>, z.ZodTypeDef, BaseBlockTransformer<object>>
      >
    >;
  },
  "strip",
  z.ZodTypeAny,
  {
    ...
    transformer?:
      | ((args_0: Map<string, unknown>, ...args: unknown[]) => BaseBlockTransformer<object>)
      | undefined;
  },
  {
    version: number;
...
export declare function defineBlockSchema<
