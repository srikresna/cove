                ...
                get: (target, p, receiver) => {
                    ...
                    if (p === 'unshift') {
                        return (...items) => {
                            ...
                            return Array.prototype.unshift.apply(target, yItems.map(yItem => createYProxy(yItem, this._options)));
                        };
                    }
...
export function createYProxy(yAbstract, options = {}) {
    ...
    return y2Native(yAbstract, { transform });
}
