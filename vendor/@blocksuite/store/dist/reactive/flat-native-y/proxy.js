...
function initializeProxy(options) {
...
function updateSignal(value, prop, receiver, options) {
    const { root, shouldByPassSignal, byPassSignalUpdate, onChange, basePath, initialized, onDispose, shouldByPassYjs, } = options;
