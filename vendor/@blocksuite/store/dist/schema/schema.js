...
import { BlockSchema } from '../model/block/zod.js';
...
export class Schema {
    constructor() {
         ...
         */
        this.safeValidate = (flavour, parentFlavour, childFlavours) => {
            try {
     ...
     */
    _matchFlavourOrRole(childValue, parentValue, childRole, parentRole) {
    ...
    _validateParent(child, parent) {
        ...
        return parentValidFlavourOrRole.some(parentValidFlavourOrRole => {
            return childValidFlavourOrRole.some(childValidFlavourOrRole => {
                ...
                if (parentValidFlavourOrRole === '*') {
                    return this._matchFlavourOrRole(childValidFlavourOrRole, _parentFlavour, _childRole, _parentRole);
                }
                if (childValidFlavourOrRole === '*') {
                    return this._matchFlavourOrRole(_childFlavour, parentValidFlavourOrRole, _childRole, _parentRole);
                }
                return (this._matchFlavourOrRole(_childFlavour, parentValidFlavourOrRole, _childRole, _parentRole) &&
