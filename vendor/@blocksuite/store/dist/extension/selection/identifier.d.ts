...
export declare const SelectionIdentifier: import("@blocksuite/global/di").ServiceIdentifier<
  SelectionConstructor<import("./base").BaseSelection>
> &
  (<
    U extends SelectionConstructor<import("./base").BaseSelection> = SelectionConstructor<
      import("./base").BaseSelection
    >,
  >(
