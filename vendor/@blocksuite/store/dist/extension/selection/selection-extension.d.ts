...
export declare class StoreSelectionExtension extends StoreExtension {
  ...
  filter$<T extends SelectionConstructor>(
    type: T,
  ): import("@preact/signals-core").ReadonlySignal<InstanceType<T>[]>;
  find<T extends SelectionConstructor>(type: T): InstanceType<T> | undefined;
  find$<T extends SelectionConstructor>(
    type: T,
  ): import("@preact/signals-core").ReadonlySignal<InstanceType<T> | undefined>;
