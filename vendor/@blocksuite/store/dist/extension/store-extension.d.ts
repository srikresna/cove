...
export declare const StoreExtensionIdentifier: import("@blocksuite/global/di").ServiceIdentifier<StoreExtension> &
  (<U extends StoreExtension = StoreExtension>(
...
export declare function isStoreExtensionConstructor(
  extension: object,
