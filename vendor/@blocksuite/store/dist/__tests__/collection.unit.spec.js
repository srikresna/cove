...
import { NoteBlockSchemaExtension, ParagraphBlockSchemaExtension, RootBlockSchemaExtension, } from './test-schema.js';
...
describe('addBlock', () => {
    ...
    it('can observe slot events', async () => {
        ...
        const block = doc.getModelById(blockId);
    ...
    it('can set doc state', () => {
        ...
        assert.deepEqual(collection.meta.docMetas.map(({ id, title, favorite }) => ({
            id,
            title,
            favorite,
        })), [
...
describe('deleteBlock', () => {
    it('delete children recursively by default', () => {
        ...
        const deletedModel = doc.getModelById('1');
    ...
    it('bring children to parent', () => {
        ...
        const deletedModel = doc.getModelById('2');
        const deletedModelParent = doc.getModelById('1');
        doc.deleteBlock(deletedModel, {
    ...
    it('bring children to other block', () => {
        ...
        const deletedModel = doc.getModelById('2');
        const moveToModel = doc.getModelById('3');
        doc.deleteBlock(deletedModel, {
