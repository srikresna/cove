import { AFFINE_KEYBOARD_TOOLBAR_WIDGET, AffineKeyboardToolbarWidget, } from './index.js';
...
export function effects() {
    customElements.define(AFFINE_KEYBOARD_TOOLBAR_WIDGET, AffineKeyboardToolbarWidget);
