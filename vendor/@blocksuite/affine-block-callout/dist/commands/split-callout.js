import { CalloutBlockModel, ParagraphBlockModel, } from '@blocksuite/affine-model';
import { focusTextModel } from '@blocksuite/affine-rich-text';
import { matchModels } from '@blocksuite/affine-shared/utils';
export const splitCalloutCommand = (ctx, next) => {
    ...
    if (matchModels(currentModel, [ParagraphBlockModel])) {
        ...
        doc.transact(() => {
            currentModel.props.text.delete(inlineIndex, currentModel.props.text.length - inlineIndex);
        });
        ...
        if (parent) {
            ...
            const newParagraphId = doc.addBlock('affine:paragraph', {
                text: afterText,
