...
export const boldDeltaToMarkdownAdapterMatcher = InlineDeltaToMarkdownAdapterExtension({
    name: 'bold',
...
export const italicDeltaToMarkdownAdapterMatcher = InlineDeltaToMarkdownAdapterExtension({
    name: 'italic',
...
export const strikeDeltaToMarkdownAdapterMatcher = InlineDeltaToMarkdownAdapterExtension({
    name: 'strike',
...
export const inlineCodeDeltaToMarkdownAdapterMatcher = InlineDeltaToMarkdownAdapterExtension({
    name: 'inlineCode',
