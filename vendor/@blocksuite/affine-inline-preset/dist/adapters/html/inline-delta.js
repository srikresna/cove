...
export const italicDeltaToHtmlAdapterMatcher = InlineDeltaToHtmlAdapterExtension({
    name: 'italic',
...
export const strikeDeltaToHtmlAdapterMatcher = InlineDeltaToHtmlAdapterExtension({
    name: 'strike',
...
export const inlineCodeDeltaToHtmlAdapterMatcher = InlineDeltaToHtmlAdapterExtension({
    name: 'inlineCode',
...
export const underlineDeltaToHtmlAdapterMatcher = InlineDeltaToHtmlAdapterExtension({
    name: 'underline',
...
export const highlightBackgroundDeltaToHtmlAdapterMatcher = InlineDeltaToHtmlAdapterExtension({
    ...
    toAST: (delta, context, provider) => {
        ...
        const backgroundVar = delta.attributes?.background.substring('var('.length, delta.attributes?.background.indexOf(')'));
...
export const highlightColorDeltaToHtmlAdapterMatcher = InlineDeltaToHtmlAdapterExtension({
    ...
    toAST: (delta, context, provider) => {
        ...
        const colorVar = delta.attributes?.color.substring('var('.length, delta.attributes?.color.indexOf(')'));
