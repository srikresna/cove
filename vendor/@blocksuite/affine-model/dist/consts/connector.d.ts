...
export declare const DEFAULT_FRONT_ENDPOINT_STYLE = PointStyle.None;
export declare const DEFAULT_REAR_ENDPOINT_STYLE = PointStyle.Arrow;
...
export declare const DEFAULT_CONNECTOR_MODE = ConnectorMode.Curve;
