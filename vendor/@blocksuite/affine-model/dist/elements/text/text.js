...
import { Bound, getPointsFromBoundWithRotation, linePolygonIntersects, pointInPolygon, polygonNearestPoint, } from '@blocksuite/global/gfx';
import { field, GfxPrimitiveElementModel } from '@blocksuite/std/gfx';
import * as Y from 'yjs';
import { FontFamily, FontStyle, FontWeight, TextAlign, } from '../../consts/index';
...
let TextElementModel = (() => {
    ...
    return class TextElementModel extends _classSuper {
        ...
        #text_accessor_storage = (__runInitializers(this, _rotate_extraInitializers), __runInitializers(this, _text_initializers, new Y.Text()));
