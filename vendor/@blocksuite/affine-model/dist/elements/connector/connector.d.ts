...
import type { BaseElementProps, PointTestOptions, SerializedElement } from '@blocksuite/std/gfx';
import { GfxPrimitiveElementModel } from '@blocksuite/std/gfx';
import * as Y from 'yjs';
import { ConnectorLabelOffsetAnchor, ConnectorMode, type PointStyle, StrokeStyle, type TextStyleProps } from '../../consts/index';
