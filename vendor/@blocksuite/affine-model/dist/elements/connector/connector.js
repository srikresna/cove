...
import { Bound, curveIntersects, getBezierNearestPoint, getBezierNearestTime, getBezierParameters, getBezierPoint, linePolylineIntersects, PointLocation, Polyline, polyLineNearestPoint, Vec, } from '@blocksuite/global/gfx';
import { derive, field, GfxPrimitiveElementModel, local, } from '@blocksuite/std/gfx';
import * as Y from 'yjs';
import { CONNECTOR_LABEL_MAX_WIDTH, ConnectorLabelOffsetAnchor, ConnectorMode, DEFAULT_CONNECTOR_MODE, DEFAULT_ROUGHNESS, FontFamily, FontStyle, FontWeight, StrokeStyle, TextAlign, } from '../../consts/index';
...
let ConnectorElementModel = (() => {
    ...
    let _labelEditing_decorators;
    let _labelEditing_initializers = [];
    let _labelEditing_extraInitializers = [];
    ...
    return class ConnectorElementModel extends _classSuper {
        static {
            ...
            _labelEditing_decorators = [local()];
            ...
            __esDecorate(this, null, _labelEditing_decorators, { kind: "accessor", name: "labelEditing", static: false, private: false, access: { has: obj => "labelEditing" in obj, get: obj => obj.labelEditing, set: (obj, value) => { obj.labelEditing = value; } }, metadata: _metadata }, _labelEditing_initializers, _labelEditing_extraInitializers);
        ...
        hasLabel() {
            return Boolean(!this.labelEditing &&
                this.labelDisplay &&
                this.labelXYWH &&
                this.text &&
                this.text.length);
        ...
        #labelEditing_accessor_storage;
        /**
         * Local control display and hide, mainly used in editing scenarios.
         */
        get labelEditing() { return this.#labelEditing_accessor_storage; }
        set labelEditing(value) { this.#labelEditing_accessor_storage = value; }
        ...
        constructor() {
            ...
            this.#labelEditing_accessor_storage = (__runInitializers(this, _labelXYWH_extraInitializers), __runInitializers(this, _labelEditing_initializers, false));
            this.#mode_accessor_storage = (__runInitializers(this, _labelEditing_extraInitializers), __runInitializers(this, _mode_initializers, DEFAULT_CONNECTOR_MODE));
            ...
            this.#stroke_accessor_storage = (__runInitializers(this, _source_extraInitializers), __runInitializers(this, _stroke_initializers, DefaultTheme.connectorColor));
