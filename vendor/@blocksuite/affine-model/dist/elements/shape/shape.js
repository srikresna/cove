...
import { field, GfxLocalElementModel, GfxPrimitiveElementModel, local, prop, } from '@blocksuite/std/gfx';
import * as Y from 'yjs';
import { DEFAULT_ROUGHNESS, FontFamily, FontStyle, FontWeight, ShapeStyle, ShapeTextFontSize, ShapeType, StrokeStyle, TextAlign, TextResizing, TextVerticalAlign, } from '../../consts/index.js';
...
let ShapeElementModel = (() => {
    ...
    return class ShapeElementModel extends _classSuper {
        static {
            ...
            _color_decorators = [field(DefaultTheme.shapeTextColor)];
        ...
        constructor() {
            ...
            this.#fillColor_accessor_storage = (__runInitializers(this, _color_extraInitializers), __runInitializers(this, _fillColor_initializers, DefaultTheme.shapeFillColor));
            ...
            this.#strokeColor_accessor_storage = (__runInitializers(this, _shapeType_extraInitializers), __runInitializers(this, _strokeColor_initializers, DefaultTheme.shapeStrokeColor));
...
let LocalShapeElementModel = (() => {
    let _classSuper = GfxLocalElementModel;
    let _color_decorators;
    let _color_initializers = [];
    let _color_extraInitializers = [];
    let _fillColor_decorators;
    ...
    let _textVerticalAlign_initializers = [];
    let _textVerticalAlign_extraInitializers = [];
    return class LocalShapeElementModel extends _classSuper {
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(_classSuper[Symbol.metadata] ?? null) : void 0;
            _color_decorators = [prop()];
            _fillColor_decorators = [prop()];
            _filled_decorators = [prop()];
            _fontFamily_decorators = [prop()];
            _fontSize_decorators = [prop()];
            _fontStyle_decorators = [prop()];
            _fontWeight_decorators = [prop()];
            _padding_decorators = [prop()];
            _radius_decorators = [prop()];
            _shadow_decorators = [prop()];
            _shapeStyle_decorators = [prop()];
            _shapeType_decorators = [prop()];
            _strokeColor_decorators = [prop()];
            _strokeStyle_decorators = [prop()];
            _strokeWidth_decorators = [prop()];
            _text_decorators = [prop()];
            _textAlign_decorators = [prop()];
            _textVerticalAlign_decorators = [prop()];
            __esDecorate(this, null, _color_decorators, { kind: "accessor", name: "color", static: false, private: false, access: { has: obj => "color" in obj, get: obj => obj.color, set: (obj, value) => { obj.color = value; } }, metadata: _metadata }, _color_initializers, _color_extraInitializers);
            __esDecorate(this, null, _fillColor_decorators, { kind: "accessor", name: "fillColor", static: false, private: false, access: { has: obj => "fillColor" in obj, get: obj => obj.fillColor, set: (obj, value) => { obj.fillColor = value; } }, metadata: _metadata }, _fillColor_initializers, _fillColor_extraInitializers);
            __esDecorate(this, null, _filled_decorators, { kind: "accessor", name: "filled", static: false, private: false, access: { has: obj => "filled" in obj, get: obj => obj.filled, set: (obj, value) => { obj.filled = value; } }, metadata: _metadata }, _filled_initializers, _filled_extraInitializers);
            __esDecorate(this, null, _fontFamily_decorators, { kind: "accessor", name: "fontFamily", static: false, private: false, access: { has: obj => "fontFamily" in obj, get: obj => obj.fontFamily, set: (obj, value) => { obj.fontFamily = value; } }, metadata: _metadata }, _fontFamily_initializers, _fontFamily_extraInitializers);
        ...
        constructor() {
            ...
            this.#color_accessor_storage = __runInitializers(this, _color_initializers, DefaultTheme.shapeTextColor);
            this.#fillColor_accessor_storage = (__runInitializers(this, _color_extraInitializers), __runInitializers(this, _fillColor_initializers, DefaultTheme.shapeFillColor));
            this.#filled_accessor_storage = (__runInitializers(this, _fillColor_extraInitializers), __runInitializers(this, _filled_initializers, false));
            this.#fontFamily_accessor_storage = (__runInitializers(this, _filled_extraInitializers), __runInitializers(this, _fontFamily_initializers, FontFamily.Inter));
            this.#fontSize_accessor_storage = (__runInitializers(this, _fontFamily_extraInitializers), __runInitializers(this, _fontSize_initializers, 16));
            this.#fontStyle_accessor_storage = (__runInitializers(this, _fontSize_extraInitializers), __runInitializers(this, _fontStyle_initializers, FontStyle.Normal));
            this.#fontWeight_accessor_storage = (__runInitializers(this, _fontStyle_extraInitializers), __runInitializers(this, _fontWeight_initializers, FontWeight.Regular));
            this.#padding_accessor_storage = (__runInitializers(this, _fontWeight_extraInitializers), __runInitializers(this, _padding_initializers, [
                SHAPE_TEXT_VERTICAL_PADDING,
                SHAPE_TEXT_PADDING,
            ]));
            this.#radius_accessor_storage = (__runInitializers(this, _padding_extraInitializers), __runInitializers(this, _radius_initializers, 0));
            this.#shadow_accessor_storage = (__runInitializers(this, _radius_extraInitializers), __runInitializers(this, _shadow_initializers, null));
            this.#shapeStyle_accessor_storage = (__runInitializers(this, _shadow_extraInitializers), __runInitializers(this, _shapeStyle_initializers, ShapeStyle.General));
            this.#shapeType_accessor_storage = (__runInitializers(this, _shapeStyle_extraInitializers), __runInitializers(this, _shapeType_initializers, ShapeType.Rect));
            this.#strokeColor_accessor_storage = (__runInitializers(this, _shapeType_extraInitializers), __runInitializers(this, _strokeColor_initializers, DefaultTheme.shapeStrokeColor));
            this.#strokeStyle_accessor_storage = (__runInitializers(this, _strokeColor_extraInitializers), __runInitializers(this, _strokeStyle_initializers, StrokeStyle.Solid));
            this.#strokeWidth_accessor_storage = (__runInitializers(this, _strokeStyle_extraInitializers), __runInitializers(this, _strokeWidth_initializers, 4));
            this.#text_accessor_storage = (__runInitializers(this, _strokeWidth_extraInitializers), __runInitializers(this, _text_initializers, ''));
            this.#textAlign_accessor_storage = (__runInitializers(this, _text_extraInitializers), __runInitializers(this, _textAlign_initializers, TextAlign.Center));
            this.#textVerticalAlign_accessor_storage = (__runInitializers(this, _textAlign_extraInitializers), __runInitializers(this, _textVerticalAlign_initializers, TextVerticalAlign.Center));
            __runInitializers(this, _textVerticalAlign_extraInitializers);
        }
    };
})();
export { LocalShapeElementModel };
