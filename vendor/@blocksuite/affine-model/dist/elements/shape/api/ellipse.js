import { Bound, clamp, getPointsFromBoundWithRotation, lineEllipseIntersects, pointInEllipse, pointInPolygon, PointLocation, rotatePoints, toRadian, Vec, } from '@blocksuite/global/gfx';
...
export const ellipse = {
    ...
    getLineIntersections(start, end, { rotate, xywh }) {
        const rad = toRadian(rotate);
