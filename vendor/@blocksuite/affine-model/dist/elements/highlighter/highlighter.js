...
import { Bound, getBoundFromPoints, getPointsFromBoundWithRotation, getQuadBoundWithRotation, getSolidStrokePoints, getSvgPathFromStroke, inflateBound, isPointOnlines, lineIntersects, PointLocation, polyLineNearestPoint, transformPointsToNewBound, Vec, } from '@blocksuite/global/gfx';
import { convert, derive, field, GfxPrimitiveElementModel, watch, } from '@blocksuite/std/gfx';
import { DEFAULT_HIGHLIGHTER_LINE_WIDTH } from '../../consts';
import { DefaultTheme } from '../../themes/index';
let HighlighterElementModel = (() => {
    ...
    return class HighlighterElementModel extends _classSuper {
        static {
        ...
        getLineIntersections(start, end) {
            ...
            const points = getPointsFromBoundWithRotation(this, _ => this.points.map(point => Vec.add(point, tl)));
        ...
        #color_accessor_storage = __runInitializers(this, _color_initializers, DefaultTheme.hightlighterColor);
        get color() { return this.#color_accessor_storage; }
        set color(value) { this.#color_accessor_storage = value; }
        #lineWidth_accessor_storage = (__runInitializers(this, _color_extraInitializers), __runInitializers(this, _lineWidth_initializers, DEFAULT_HIGHLIGHTER_LINE_WIDTH));
...
export { HighlighterElementModel };
