...
import { canSafeAddToContainer, field, GfxGroupLikeElementModel, local, observe, } from '@blocksuite/std/gfx';
    ...
    return class GroupElementModel extends _classSuper {
        ...
        static propsToY(props) {
            if (typeof props.title === 'string') {
                props.title = new Y.Text(props.title);
            }
        ...
        #children_accessor_storage = __runInitializers(this, _children_initializers, new Y.Map());
        ...
        #title_accessor_storage = (__runInitializers(this, _showTitle_extraInitializers), __runInitializers(this, _title_initializers, new Y.Text()));
