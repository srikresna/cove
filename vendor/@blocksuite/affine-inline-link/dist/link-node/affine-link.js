...
import { ParseDocUrlProvider, ToolbarRegistryIdentifier, } from '@blocksuite/affine-shared/services';
...
import { INLINE_ROOT_ATTR, ZERO_WIDTH_FOR_EMPTY_LINE, } from '@blocksuite/std/inline';
...
let AffineLink = (() => {
    ...
    return class AffineLink extends _classSuper {
        static {
