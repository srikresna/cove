...
import { tocContext } from './config.js';
...
let OutlineViewer = (() => {
  ...
  `; }
        ...
        connectedCallback() {
            ...
            // title update
            this.disposables.add(this.editor.store.workspace.meta.docMetaUpdated.subscribe(() => {
                this.requestUpdate();
            }));
            this._setContext();
        }
        ...
        render() {
            ...
            const toggleOutlinePanelButton = this.toggleOutlinePanel !== null
    ...
    `;
        ...
        constructor() {
            ...
            this.#_activeItem_accessor_storage = (__runInitializers(this, __context_extraInitializers), __runInitializers(this, __activeItem_initializers, null));
