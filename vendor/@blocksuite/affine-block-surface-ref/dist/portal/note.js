...
import { DefaultTheme, NoteDisplayMode, NoteShadow, } from '@blocksuite/affine-model';
import { EDGELESS_BLOCK_CHILD_BORDER_WIDTH, EDGELESS_BLOCK_CHILD_PADDING, } from '@blocksuite/affine-shared/consts';
import { ThemeProvider } from '@blocksuite/affine-shared/services';
import { deserializeXYWH } from '@blocksuite/global/gfx';
import { WithDisposable } from '@blocksuite/global/lit';
import { BlockStdScope, ShadowlessElement, } from '@blocksuite/std';
...
let SurfaceRefNotePortal = (() => {
  ...
  `; }
        ...
        firstUpdated() {
            this.disposables.add(this.model.propsUpdated.subscribe(() => this.requestUpdate()));
        }
        render() {
            ...
            const backgroundColor = this.host.std
                .get(ThemeProvider)
                .generateColorProperty(model.props.background, DefaultTheme.noteBackgrounColor);
