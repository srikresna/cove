...
const surfaceRefSlashMenuConfig = {
    items: ({ std, model }) => {
        ...
        const insertSurfaceRefAndSelect = (reference) => {
            ...
            if (!result.insertedSurfaceRefBlockId)
                return;
            std.selection.set([
        ...
        const frameItems = frameMgr.frames.map(frameModel => ({
...
export const SurfaceRefSlashMenuConfigExtension = SlashMenuConfigExtension(SurfaceRefBlockSchema.model.flavour, surfaceRefSlashMenuConfig);
