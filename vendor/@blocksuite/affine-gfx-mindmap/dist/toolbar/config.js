...
import { LayoutType, MindmapElementModel, MindmapStyle, ShapeElementModel, } from '@blocksuite/affine-model';
import { ToolbarModuleExtension, } from '@blocksuite/affine-shared/services';
import { getMostCommonValue } from '@blocksuite/affine-shared/utils';
import { renderMenu, } from '@blocksuite/affine-widget-edgeless-toolbar';
import { RadiantIcon, RightLayoutIcon, StyleIcon } from '@blocksuite/icons/lit';
import { BlockFlavourIdentifier } from '@blocksuite/std';
import { MindmapStyleFour, MindmapStyleOne, MindmapStyleThree, MindmapStyleTwo, } from '../view/index';
...
export const createMindmapStyleActionMenu = (ctx, models) => {
...
export const createMindmapLayoutActionMenu = (ctx, models) => {
    const layoutType = getMostCommonValue(models, 'layoutType') ?? LayoutType.BALANCE;
    const onPick = (layoutType) => {
        for (const model of models) {
    ...
    actions: [
        {
            ...
            content(ctx) {
                ...
                if (models.length !== mindmaps.length)
                    return null;
