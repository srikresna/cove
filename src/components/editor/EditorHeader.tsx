...
import { Pin, Star, Trash2, Copy, Maximize2, Minimize2, ArrowRightLeft } from 'lucide-react'
...
export const EditorHeader: React.FC<EditorHeaderProps> = ({
  ...
  const { updateNote, deleteNote, duplicateNote, togglePinNote, toggleFavoriteNote } = useNoteStore()
